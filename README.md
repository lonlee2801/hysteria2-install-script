...
```bash
bash <(curl -fsSL [https://raw.githubusercontent.com/lonlee2801/hysteria2-install-script/main/install.sh](https://raw.githubusercontent.com/YOUR_USERNAME/hysteria2-install-script/main/install.sh))
